...
public abstract class AbstractClass {
    ...
    * @return
    */
    abstract double calculateSimilarity( String user1, String user2, String
    ...
    * @return
    */
    abstract ArrayList< TrackInfo > makePlaylist( String user, String fieldName,
    ...
    */
    ...
    public void setUserTrackMap(HashMap< String, ArrayList< TrackInfo > > userTrackMap ) {
    ...
    * @param track
    */
    void addTrack( HashMap< String, ArrayList< TrackInfo > > map, String key, TrackInfo track ) {
