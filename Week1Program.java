 ...
 * *
 * * @author BennieAndTheJets
 * */
public class Week1Program {
	/*
	 * Given the age of an artifact in years, return the percent of C14 left in it.
	 * Here a percentage is a double in the range [0.0, 1.0]. Remember that N / N0 is the percent of C14
	...
	double radiocarbonPercent ( int age ) {
		...
		/**
		* Given the percentage of C14 remaining in an artifact, return the age of the
		artifact in years.
		...
		*/
		...
		/**
		* Given the percentage of C14 remaining in an artifact, return the year of the
		* artifact was created or the
		...
		*/
		...
		age = 1845;
		System.out.printf( "radiocarbonDate( %f ) = the year %d. ", percentage,
		year );
		if ( Math.abs( year - (Calendar.getInstance().get(Calendar.YEAR) - age ) )
		 <= 5.0) {
		System.out.println( "Success!\n" );
		} else {
		System.out.println( "FAILED!\n" );
